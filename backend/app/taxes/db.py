    ...
    try:
        with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
            ...
            df_facts = pd.read_sql("""
                ...
                WHERE factor = %s AND item_id = %s
            """, conn, params=(factor, item_id))
            
            # Get predictions
            df_preds_long = pd.read_sql("""
